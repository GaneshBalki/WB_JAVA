...
<form action="addnewuser" method="post">
  <div class="container">
   ...
   <!--  <label for="sid"><b></b></label>
    <input type="text" placeholder="User Number " name="id" id="id" required>
 -->
    ...
    <input type="text" placeholder="Enter User name" name="address" id="addr" required>
   ...
   <label for="psw2">Female</label><input type="radio" name="gender" id="psw2" value="Female"/>
    ...
    <input type="text" placeholder="Enter city" name="city" id="psw" required>
